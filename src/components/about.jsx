...
function ComponentsAbout() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ".about-text",
      { opacity: 0, y: 50 },
      { opacity: 1, y: 0, duration: 4, delay: 0.2 }
    );
    gsap.fromTo(
      ".about-image",
      { opacity: 0, x: -100 },
      { opacity: 1, x: 0, duration: 4, delay: 0.4 }
    );
    gsap.fromTo(
      ".social-icons a",
      { opacity: 0, y: 20 },
  ...
  return (
    <section id="about" className="lg:mt-16 lg:-ml-8 lg:max-w-full">
      <div className="flex flex-wrap">
        <div className="w-full px-4 self-end lg:w-1/2" data-aos="fade-left">
          <div className="relative mt-10 lg:mt-0 -ml-7 lg:right-0">
            <img
              ...
              alt=""
              className="lg:max-w-96 ml-3 px-2 lg:mx-auto rounded-2xl about-image"
            />
          </div>
        </div>
        <div className="w-full px-4 lg:w-1/2 about-text">
          ...
          <div className="flex items-center social-icons">
            {/* Instagram */}
            <a
              href="https://www.instagram.com/muhamad_daffa_malik/"
              className="w-10 h-10 rounded-full justify-center border mr-3 flex border-slate-300 
                    hover:border-cyan-400 hover:bg-cyan-400 hover:text-white text-slate-400"
            >
              <svg
                role="img"
                width={20}
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/daffa.malik.5055/"
              className="w-10 h-10 rounded-full justify-center border mr-3 flex border-slate-300 
                    hover:border-cyan-400 hover:bg-cyan-400 hover:text-white text-slate-400"
            >
              <svg
            ...
            {/* Tiktok */}
            <a
              href="https://www.tiktok.com/@dfhv123?lang=en"
              className="w-10 h-10 rounded-full justify-center border mr-3 flex border-slate-300 
                  hover:border-cyan-400 hover:bg-cyan-400 hover:text-white text-slate-400"
            >
              <svg
            ...
            {/* Github */}
            <a
              href="https://github.com/DaffaMalik12"
              className="w-10 h-10 rounded-full justify-center border mr-3 flex border-slate-300 
                  hover:border-cyan-400 hover:bg-cyan-400 hover:text-white text-slate-400"
            >
              <svg
            ...
            {/* Linked */}
            <a
              href="https://www.linkedin.com/in/muhammad-daffa-malik-akram/"
              className="w-10 h-10 rounded-full justify-center border mr-3 flex border-slate-300 
                  hover:border-cyan-400 hover:bg-cyan-400 hover:text-white text-slate-400"
            >
              <svg
